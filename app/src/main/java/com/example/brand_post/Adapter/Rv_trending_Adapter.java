...
public class Rv_trending_Adapter extends RecyclerView.Adapter<Rv_trending_Adapter.viewData> {

    Activity activity;
    List<Sub_Model> list;
    private String TAG;

    public Rv_trending_Adapter(FragmentActivity mainActivity, List<Sub_Model> list) {
    ...
    public viewData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(activity).inflate(R.layout.blue_item_bg, parent, false);
